...
public class S2CInventoryItemsPlacePacket extends Packet {
    public S2CInventoryItemsPlacePacket(List<PlayerPocket> playerPocketList) {
        super(PacketOperations.S2CInventoryItemsPlace);
