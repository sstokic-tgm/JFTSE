...
import com.ft.emulator.server.database.model.lottery.LotteryItemDto;
...
import com.ft.emulator.server.game.core.item.EItemChar;
import com.ft.emulator.server.game.core.packet.packets.inventory.S2CInventoryDataPacket;
import com.ft.emulator.server.game.core.packet.packets.inventory.S2CInventoryItemRemoveAnswerPacket;
...
public class LotteryService {
    ...
    private PlayerPocket saveWinningItem(Product winningItem, LotteryItemDto lotteryItem, Pocket pocket) {
        PlayerPocket playerPocket = playerPocketService.getItemAsPocketByItemIndex(winningItem.getItem0(), pocket);
