...
import com.ft.emulator.server.database.repository.challenge.ChallengeProgressRepository;
import com.ft.emulator.server.database.repository.challenge.ChallengeRepository;
import com.ft.emulator.server.game.core.packet.packets.challenge.S2CChallengeFinishPacket;
...
public class ChallengeService {
    ...
    public void finishGame(Connection connection, boolean win) {
        ...
        player.setExpPoints(player.getExpPoints() + challenge.getRewardExp());
