...
public class S2CRoomSetGuardians extends Packet {
    public S2CRoomSetGuardians(GuardianBase firstMonster, GuardianBase secondMonster, GuardianBase thirdMonster) {
        ...
        // (GuardianInfo.set)
        this.write(firstMonster == null ? (byte) 0 : firstMonster.getGuardIndex().byteValue());
        this.write(secondMonster == null ? (byte) 0 : secondMonster.getGuardIndex().byteValue());
        this.write(thirdMonster == null ? (byte) 0 : thirdMonster.getGuardIndex().byteValue());
    }
}