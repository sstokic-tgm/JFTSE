...
@Setter
@NoArgsConstructor
public class RefreshFriendListMessage extends AbstractBaseMessage {
    private Long playerId;

    @Builder
    public RefreshFriendListMessage(Long playerId) {
        this.playerId = playerId;
    }

    @Override
    public String getMessageType() {
        return MessageTypes.REFRESH_FRIEND_LIST.getValue();
    }
}
